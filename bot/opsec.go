...
func mew() byte      { return byte(0x5E ^ 0x47) }  // patched by setup.py
func mewtwo() byte   { return byte(0x64 ^ 0xCE) }  // patched by setup.py
func celebi() byte   { return byte(0xAE ^ 0x9F) }  // patched by setup.py
func jirachi() byte  { return byte(0xF2 ^ 0x5D) }  // patched by setup.py
func shaymin() byte  { return byte(0xED ^ 0xD1) }  // patched by setup.py
func phione() byte   { return byte(0x41 ^ 0xF1) }  // patched by setup.py
func manaphy() byte  { return byte(0x9E ^ 0xA2) }  // patched by setup.py
func victini() byte  { return byte(0x0C ^ 0x0E) }  // patched by setup.py
func keldeo() byte   { return byte(0x4B ^ 0xC9) }  // patched by setup.py
func meloetta() byte { return byte(0x22 ^ 0x95) }  // patched by setup.py
func genesect() byte { return byte(0x3C ^ 0xBD) }  // patched by setup.py
func diancie() byte  { return byte(0x5A ^ 0xC6) }  // patched by setup.py
func hoopa() byte    { return byte(0x3F ^ 0xA8) }  // patched by setup.py
func volcanion() byte { return byte(0x5E ^ 0x6C) }  // patched by setup.py
func magearna() byte { return byte(0x9F ^ 0xD2) }  // patched by setup.py
func marshadow() byte { return byte(0x12 ^ 0x23) }  // patched by setup.py
func zeraora() byte  { return byte(0x28 ^ 0x05) }  // patched by setup.py
func zarude() byte   { return byte(0x24 ^ 0x04) }  // patched by setup.py
func regieleki() byte { return byte(0x36 ^ 0xB1) }  // patched by setup.py
func regidrago() byte { return byte(0x03 ^ 0x5D) }  // patched by setup.py
func glastrier() byte { return byte(0xC9 ^ 0x4B) }  // patched by setup.py
func spectrier() byte { return byte(0xEC ^ 0xDD) }  // patched by setup.py
func calyrex() byte  { return byte(0x15 ^ 0x16) }  // patched by setup.py
func wyrdeer() byte  { return byte(0x2E ^ 0x26) }  // patched by setup.py
func kleavor() byte  { return byte(0x14 ^ 0xFD) }  // patched by setup.py
func ursaluna() byte { return byte(0x80 ^ 0x21) }  // patched by setup.py
func basculegion() byte { return byte(0xE3 ^ 0x17) }  // patched by setup.py
func sneasler() byte { return byte(0x70 ^ 0xF3) }  // patched by setup.py
func overqwil() byte { return byte(0x9F ^ 0x2E) }  // patched by setup.py
func enamorus() byte { return byte(0x5C ^ 0x47) }  // patched by setup.py
func tinkaton() byte { return byte(0x32 ^ 0x7C) }  // patched by setup.py
func annihilape() byte { return byte(0xB7 ^ 0x1E) }  // patched by setup.py
