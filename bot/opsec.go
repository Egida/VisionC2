...
func mew() byte      { return byte(0xAB ^ 0x38) }  // patched by setup.py
func mewtwo() byte   { return byte(0x51 ^ 0xF0) }  // patched by setup.py
func celebi() byte   { return byte(0x24 ^ 0xEF) }  // patched by setup.py
func jirachi() byte  { return byte(0x07 ^ 0xEA) }  // patched by setup.py
func shaymin() byte  { return byte(0xA3 ^ 0x8A) }  // patched by setup.py
func phione() byte   { return byte(0x3E ^ 0x8E) }  // patched by setup.py
func manaphy() byte  { return byte(0xA6 ^ 0x4C) }  // patched by setup.py
func victini() byte  { return byte(0x80 ^ 0x6C) }  // patched by setup.py
func keldeo() byte   { return byte(0xA9 ^ 0xB4) }  // patched by setup.py
func meloetta() byte { return byte(0x68 ^ 0x34) }  // patched by setup.py
func genesect() byte { return byte(0x23 ^ 0xF5) }  // patched by setup.py
func diancie() byte  { return byte(0x52 ^ 0x8D) }  // patched by setup.py
func hoopa() byte    { return byte(0xE0 ^ 0xDE) }  // patched by setup.py
func volcanion() byte { return byte(0xAB ^ 0xC0) }  // patched by setup.py
func magearna() byte { return byte(0xAC ^ 0xF5) }  // patched by setup.py
func marshadow() byte { return byte(0xAF ^ 0xEE) }  // patched by setup.py
func zeraora() byte  { return byte(0xCA ^ 0x9B) }  // patched by setup.py
func zarude() byte   { return byte(0xB1 ^ 0x14) }  // patched by setup.py
func regieleki() byte { return byte(0x45 ^ 0xD7) }  // patched by setup.py
func regidrago() byte { return byte(0xCF ^ 0x73) }  // patched by setup.py
func glastrier() byte { return byte(0x70 ^ 0xDE) }  // patched by setup.py
func spectrier() byte { return byte(0x0D ^ 0xD5) }  // patched by setup.py
func calyrex() byte  { return byte(0x5F ^ 0xC0) }  // patched by setup.py
func wyrdeer() byte  { return byte(0x67 ^ 0x88) }  // patched by setup.py
func kleavor() byte  { return byte(0x90 ^ 0x30) }  // patched by setup.py
func ursaluna() byte { return byte(0x98 ^ 0x41) }  // patched by setup.py
func basculegion() byte { return byte(0x22 ^ 0x24) }  // patched by setup.py
func sneasler() byte { return byte(0x1F ^ 0x3C) }  // patched by setup.py
func overqwil() byte { return byte(0xD2 ^ 0xCA) }  // patched by setup.py
func enamorus() byte { return byte(0xB4 ^ 0xDB) }  // patched by setup.py
func tinkaton() byte { return byte(0x0B ^ 0x91) }  // patched by setup.py
func annihilape() byte { return byte(0xFB ^ 0xE1) }  // patched by setup.py
