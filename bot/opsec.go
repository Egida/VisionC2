...
func mew() byte      { return byte(0xD2 ^ 0x1A) }  // patched by setup.py
func mewtwo() byte   { return byte(0x1A ^ 0x05) }  // patched by setup.py
func celebi() byte   { return byte(0x3E ^ 0xD4) }  // patched by setup.py
func jirachi() byte  { return byte(0x29 ^ 0xE3) }  // patched by setup.py
func shaymin() byte  { return byte(0x3C ^ 0x9B) }  // patched by setup.py
func phione() byte   { return byte(0xC4 ^ 0x61) }  // patched by setup.py
func manaphy() byte  { return byte(0x57 ^ 0x7F) }  // patched by setup.py
func victini() byte  { return byte(0x4D ^ 0x1F) }  // patched by setup.py
func keldeo() byte   { return byte(0x48 ^ 0x6D) }  // patched by setup.py
func meloetta() byte { return byte(0x04 ^ 0x38) }  // patched by setup.py
func genesect() byte { return byte(0xEA ^ 0x5F) }  // patched by setup.py
func diancie() byte  { return byte(0x2D ^ 0xA5) }  // patched by setup.py
func hoopa() byte    { return byte(0x7C ^ 0x80) }  // patched by setup.py
func volcanion() byte { return byte(0x71 ^ 0xF0) }  // patched by setup.py
func magearna() byte { return byte(0xF9 ^ 0x1A) }  // patched by setup.py
func marshadow() byte { return byte(0x68 ^ 0x19) }  // patched by setup.py
func zeraora() byte  { return byte(0x41 ^ 0x4D) }  // patched by setup.py
func zarude() byte   { return byte(0x83 ^ 0x23) }  // patched by setup.py
func regieleki() byte { return byte(0xF6 ^ 0x03) }  // patched by setup.py
func regidrago() byte { return byte(0x2D ^ 0x22) }  // patched by setup.py
func glastrier() byte { return byte(0x87 ^ 0x43) }  // patched by setup.py
func spectrier() byte { return byte(0x51 ^ 0x88) }  // patched by setup.py
func calyrex() byte  { return byte(0x6C ^ 0xD6) }  // patched by setup.py
func wyrdeer() byte  { return byte(0x12 ^ 0x4D) }  // patched by setup.py
func kleavor() byte  { return byte(0xEC ^ 0x7E) }  // patched by setup.py
func ursaluna() byte { return byte(0x24 ^ 0x0E) }  // patched by setup.py
func basculegion() byte { return byte(0x1E ^ 0x5A) }  // patched by setup.py
func sneasler() byte { return byte(0xE3 ^ 0x79) }  // patched by setup.py
func overqwil() byte { return byte(0x23 ^ 0x55) }  // patched by setup.py
func enamorus() byte { return byte(0xFD ^ 0xAA) }  // patched by setup.py
func tinkaton() byte { return byte(0x1B ^ 0x11) }  // patched by setup.py
func annihilape() byte { return byte(0x58 ^ 0xA3) }  // patched by setup.py
