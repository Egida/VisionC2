...
func mew() byte      { return byte(0x5B ^ 0xB8) }  // patched by setup.py
func mewtwo() byte   { return byte(0x6F ^ 0xF6) }  // patched by setup.py
func celebi() byte   { return byte(0x28 ^ 0xE6) }  // patched by setup.py
func jirachi() byte  { return byte(0x57 ^ 0xE1) }  // patched by setup.py
func shaymin() byte  { return byte(0xBD ^ 0x48) }  // patched by setup.py
func phione() byte   { return byte(0x61 ^ 0xB7) }  // patched by setup.py
func manaphy() byte  { return byte(0x6C ^ 0x81) }  // patched by setup.py
func victini() byte  { return byte(0x23 ^ 0x47) }  // patched by setup.py
func keldeo() byte   { return byte(0x19 ^ 0xF2) }  // patched by setup.py
func meloetta() byte { return byte(0xE9 ^ 0x5D) }  // patched by setup.py
func genesect() byte { return byte(0x0D ^ 0xCF) }  // patched by setup.py
func diancie() byte  { return byte(0xD8 ^ 0xE0) }  // patched by setup.py
func hoopa() byte    { return byte(0x84 ^ 0x7F) }  // patched by setup.py
func volcanion() byte { return byte(0x56 ^ 0x83) }  // patched by setup.py
func magearna() byte { return byte(0x2A ^ 0x5C) }  // patched by setup.py
func marshadow() byte { return byte(0x3F ^ 0xD8) }  // patched by setup.py
func zeraora() byte  { return byte(0x5B ^ 0xE1) }  // patched by setup.py
func zarude() byte   { return byte(0xB2 ^ 0xEB) }  // patched by setup.py
func regieleki() byte { return byte(0x61 ^ 0xE7) }  // patched by setup.py
func regidrago() byte { return byte(0xF9 ^ 0x06) }  // patched by setup.py
func glastrier() byte { return byte(0x93 ^ 0x17) }  // patched by setup.py
func spectrier() byte { return byte(0x69 ^ 0x30) }  // patched by setup.py
func calyrex() byte  { return byte(0x0F ^ 0xF8) }  // patched by setup.py
func wyrdeer() byte  { return byte(0x16 ^ 0xD8) }  // patched by setup.py
func kleavor() byte  { return byte(0x69 ^ 0x7E) }  // patched by setup.py
func ursaluna() byte { return byte(0x4E ^ 0x05) }  // patched by setup.py
func basculegion() byte { return byte(0xAD ^ 0x52) }  // patched by setup.py
func sneasler() byte { return byte(0x1D ^ 0xC0) }  // patched by setup.py
func overqwil() byte { return byte(0x76 ^ 0x18) }  // patched by setup.py
func enamorus() byte { return byte(0x3A ^ 0x2C) }  // patched by setup.py
func tinkaton() byte { return byte(0x19 ^ 0xB4) }  // patched by setup.py
func annihilape() byte { return byte(0x84 ^ 0x91) }  // patched by setup.py
