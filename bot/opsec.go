...
func mew() byte      { return byte(0xA5 ^ 0x2C) }  // patched by setup.py
func mewtwo() byte   { return byte(0x60 ^ 0x01) }  // patched by setup.py
func celebi() byte   { return byte(0x2F ^ 0x71) }  // patched by setup.py
func jirachi() byte  { return byte(0x45 ^ 0x82) }  // patched by setup.py
func shaymin() byte  { return byte(0x7C ^ 0xF1) }  // patched by setup.py
func phione() byte   { return byte(0xBA ^ 0xA6) }  // patched by setup.py
func manaphy() byte  { return byte(0x1F ^ 0xFA) }  // patched by setup.py
func victini() byte  { return byte(0xCD ^ 0x90) }  // patched by setup.py
func keldeo() byte   { return byte(0xFC ^ 0xB8) }  // patched by setup.py
func meloetta() byte { return byte(0x85 ^ 0x57) }  // patched by setup.py
func genesect() byte { return byte(0x60 ^ 0x22) }  // patched by setup.py
func diancie() byte  { return byte(0x33 ^ 0x34) }  // patched by setup.py
func hoopa() byte    { return byte(0x1A ^ 0xFE) }  // patched by setup.py
func volcanion() byte { return byte(0x1F ^ 0x99) }  // patched by setup.py
func magearna() byte { return byte(0x62 ^ 0x3A) }  // patched by setup.py
func marshadow() byte { return byte(0x0E ^ 0xD3) }  // patched by setup.py
func zeraora() byte  { return byte(0xBB ^ 0x79) }  // patched by setup.py
func zarude() byte   { return byte(0x1E ^ 0x1E) }  // patched by setup.py
func regieleki() byte { return byte(0x5A ^ 0x27) }  // patched by setup.py
func regidrago() byte { return byte(0x2A ^ 0x6B) }  // patched by setup.py
func glastrier() byte { return byte(0x9A ^ 0xB9) }  // patched by setup.py
func spectrier() byte { return byte(0x22 ^ 0x7E) }  // patched by setup.py
func calyrex() byte  { return byte(0xAB ^ 0x32) }  // patched by setup.py
func wyrdeer() byte  { return byte(0x05 ^ 0x1E) }  // patched by setup.py
func kleavor() byte  { return byte(0x08 ^ 0xD6) }  // patched by setup.py
func ursaluna() byte { return byte(0x14 ^ 0x67) }  // patched by setup.py
func basculegion() byte { return byte(0x05 ^ 0xFE) }  // patched by setup.py
func sneasler() byte { return byte(0xD1 ^ 0x72) }  // patched by setup.py
func overqwil() byte { return byte(0xB7 ^ 0x7A) }  // patched by setup.py
func enamorus() byte { return byte(0x47 ^ 0xCD) }  // patched by setup.py
func tinkaton() byte { return byte(0x2E ^ 0xB7) }  // patched by setup.py
func annihilape() byte { return byte(0xB4 ^ 0x74) }  // patched by setup.py
